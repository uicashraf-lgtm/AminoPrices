...
class agencygrove_Admin_Info {
    ...
    public function __construct() {
        ...
        add_action( 'wp_ajax_dismiss_agencygrove_notification', array( $this, 'dismiss_notification_ajax_handler' ) );
    }
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('AgencyGrove Theme', 'agencygrove'),
            esc_html__('AgencyGrove Theme', 'agencygrove'),
            'edit_theme_options',
            'agencygrove',
    ...
    public function reset_notification_dismissal() {
        delete_transient('agencygrove_notification_dismissed');
    }
    ...
    public function compatible_check() {
        $dismissed = get_transient('agencygrove_notification_dismissed');
        if ($dismissed !== '1') {
    ...
    public function dismiss_notification() {
        set_transient('agencygrove_notification_dismissed', '1', 7 * DAY_IN_SECONDS);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_agencygrove_notification',
