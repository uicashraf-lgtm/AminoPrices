...
class PA_Shortcodes {
    ...
    public function register_assets() {
        ...
        wp_register_script('pa-dashboard-js',   plugin_dir_url(__FILE__) . '../assets/js/dashboard.js',   array(), '0.9.20', true);
        wp_register_script('pa-suppliers-js',   plugin_dir_url(__FILE__) . '../assets/js/suppliers.js',   array(), '0.9.20', true);
        wp_register_script('pa-about-js',       plugin_dir_url(__FILE__) . '../assets/js/about.js',       array(), '0.9.20', true);
    }
    ...
    public function render_dashboard_shortcode() {
        ...
        window.PA_UI = {
            ...
            sse_url:  <?php echo json_encode($this->api->sse_url()); ?>,
            popular: ["Retatrutide","Tirzepatide","Tesamorelin","GHK-Cu","Ipamorelin/CJC-1295","BPC-157/TB-500","MOTS-c","BPC-157"],
            categories: [
            ...
            price_ranges: ["Any Price","$0 - $50","$50 - $100","$100 - $250","$250 - $500","$500+"],
            sort_options: ["Popularity","Price: Low to High","Price: High to Low","Newest"]
        };
        </script>
        <div class="pa-shell">
